...
export default function Routing({ user }) {
  return (
    <Routes>
      <Route user={user} exact path="/home/:uid" element={<Home user={user} />} />
      <Route user={user} exact path="/moodtracker" element={<MoodTracker user={user} />} />
      <Route user={user} exact path="/addentry" element={<AddEntry user={user} />} />
      <Route
        user={user}
        exact
      ...
      <Route user={user} exact path="/visionboardedit/:vbEditKey" element={<AddEditVisionBoard user={user} />} />
      <Route user={user} exact path="/visionboards/add" element={<AddEditVBForm user={user} />} />
    </Routes>
  );
}
